export interface DiceSkinMaterial {
  ...
  thickness?: number;
  ior?: number;
  textureType?: 'none' | 'wood' | 'leather' | 'paper' | 'brushed-metal' | 'crystal' | 'glass';
}
...
export const SKINS: DiceSkin[] = [
  ...
  },
  {
    ...
    dotColor: '#FFFFFF',
    preview: '#7aaad8',
    previewGradient: 'linear-gradient(135deg, #b0d4f1 0%, #7aaad8 25%, #4488cc 50%, #9ac0e8 75%, #b8d8f4 100%)',
  },
  {
    id: 'glass',
    name: 'Glass',
    ...
    dotColor: '#FFFFFF',
    preview: '#c8dce8',
    previewGradient: 'linear-gradient(135deg, #f0f8ff 0%, #d8eaf4 25%, #b8d0e0 50%, #e0f0ff 75%, #f4faff 100%)',
  },
  {
    id: 'brown-leather',
    name: 'Brown Leather',
